...
import { ResizableImagePreview } from '@/components/upload/ResizableImagePreview';
...
/**
 * Upload panel component handling image upload and preview flow
 * @param {UploadPanelProps} props - Component properties
 * @return {JSX.Element} Upload panel element
 */
    ...
    async (file: File) => {
      ...
      try {
        ...
        if (existingTask) {
          ...
          console.log(
            '📦 [UploadPanel] Found existing task in history, reusing:',
            existingTask.taskId
          );
          ...
          setTaskStateForTask(nextTaskId, {
            ...
            imageCode: existingTask.imageCode ?? null,
          ...
          const savedSummary = await saveTaskSummary({
            ...
            processedImage: {
              base64: processed.base64,
              processedBlob: processed.processedBlob,
              exif: processed.exif,
              dimensions: processed.dimensions
            }
          });
          ...
          setTaskStateForTask(nextTaskId, {
            selectedFileName: file.name,
            imageHash: savedSummary.imageHash ?? null,
            imageCode: savedSummary.imageCode ?? null,
      ...
      <CardContent className="flex-1 min-h-0 flex flex-col overflow-hidden">
        <div className="flex-1 min-h-0 space-y-3 overflow-y-auto pr-1">
          ...
          {!processedImage ? (
            ...
            <div className="shrink-0 min-h-72 sm:min-h-96 flex flex-col gap-3">
        ...
        <div className="shrink-0 border-t border-border/40 pt-3 space-y-3 bg-card/60">
